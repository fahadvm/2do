...
const Home = () => {
  ...
  return (
    <div style={{ backgroundColor: '#fff', minHeight: '100vh', color: '#333' }}>
      ...
      <div style={{ padding: '40px 60px 80px', display: 'flex', alignItems: 'center', maxWidth: '1400px', margin: '0 auto' }}>
        <div style={{ flex: 1 }}>
          <h1 style={{ fontSize: '4.5rem', lineHeight: '1.1', fontWeight: '700', marginBottom: '24px', color: '#1f2937' }}>
          ...
          <div style={{ display: 'flex', gap: '16px' }}>
            <div style={{ backgroundColor: '#000', color: '#fff', padding: '8px 20px', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
              ...
              <div style={{ fontSize: '0.7rem' }}>Download on the <br /> <span style={{ fontSize: '1.1rem', fontWeight: '700' }}>App Store</span></div>
            </div>
            <div style={{ backgroundColor: '#000', color: '#fff', padding: '8px 20px', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
              <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="google" width="24" />
              <div style={{ fontSize: '0.7rem' }}>GET IT ON <br /> <span style={{ fontSize: '1.1rem', fontWeight: '700' }}>Google Play</span></div>
            </div>
          </div>
        </div>
      ...
      <div id="benefits" ref={featuresRef} style={{ padding: '60px' }}>
        ...
        <div style={{ backgroundColor: '#fcd34d', borderRadius: '40px', padding: '80px', display: 'flex', alignItems: 'center', gap: '80px', marginBottom: '60px' }}>
          <div style={{ flex: 1, display: 'flex', justifyContent: 'center' }}>
            <div style={{ width: '320px', height: '600px', backgroundColor: '#fff', borderRadius: '40px', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.25)', padding: '20px', border: '8px solid #333' }}>
              ...
              <div style={{ padding: '10px', backgroundColor: '#f3f4f6', borderRadius: '12px', marginBottom: '20px' }}>Search task...</div>
              ...
              <div style={{ color: '#9ca3af', fontSize: '0.7rem', fontWeight: '700', marginBottom: '10px' }}>TODAY</div>
        ...
        <div style={{ padding: '80px', display: 'flex', alignItems: 'center', gap: '80px' }}>
          <div style={{ flex: 1 }}>
          ...
          <div style={{ flex: 1, display: 'flex', justifyContent: 'center' }}>
            <div style={{ width: '320px', height: '600px', backgroundColor: '#fff', borderRadius: '40px', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.15)', padding: '20px', border: '8px solid #333' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
                <img src="https://i.pravatar.cc/40" style={{ borderRadius: '20px' }} alt="user" />
              ...
              <div style={{ background: '#fef3c7', padding: '15px', borderRadius: '15px', marginBottom: '20px' }}>
      ...
      <div style={{ backgroundColor: '#f9fafb', padding: '100px 60px', textAlign: 'center' }}>
